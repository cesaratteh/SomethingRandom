...
public class Player {
    ...
    public void takeATotoroFromPlayer() {
        if (!isHasTotorosLeft()) {
            throw new RuntimeException("Can't place totoro. Everything.models.Player doesn't have enough"); // TODO: 3/19/2017 Replace with logging
        }
    ...
    public void takeXMeeplesFromPlayer(final int numberOfMeeplesToPlace) {
        if ( !isHasEnoughMeeples(numberOfMeeplesToPlace) ) {
            throw new RuntimeException("Can't place meeples. Everything.models.Player doesn't have enough"); // TODO: 3/19/2017 Replace with logging
        }
    ...
    public void takeATigerFromPlayer() {
        if (!isHasTigersLeft()) {
            throw new RuntimeException("Can't place tiger. Everything.models.Player doesnt have enough");
        }
